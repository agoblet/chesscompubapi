...
func TestGetPlayerProfile_ShouldGetProfile(t *testing.T) {
	runOutputTestWithTestServer(
		...
		func(c *chesscompubapi.Client) (chesscompubapi.PlayerProfile, error) {
			return c.GetPlayerProfile("hikaru")
		},
		chesscompubapi.PlayerProfile{
			Avatar:      "https://images.chesscomfiles.com/uploads/v1/user/15448422.da101127.200x200o.64ebfda98bc2.png",
			PlayerId:    15448422,
			URL:         "https://www.chess.com/member/Hikaru",
			Name:        "Hikaru Nakamura",
...
func TestGetPlayerProfile_ShouldGetProfileWithEmptyCountry(t *testing.T) {
	runOutputTestWithTestServer(
		[]testServerRoute{
			{
				pattern: "/pub/player/emptycountry",
				responseBody: `{
					"country":"",
					"last_online":1687899135,
					"joined":1389043258
		...
		func(c *chesscompubapi.Client) (chesscompubapi.PlayerProfile, error) {
			return c.GetPlayerProfile("emptycountry")
		},
		chesscompubapi.PlayerProfile{
			LastOnline: chesscompubapi.UnixSecondsTimestamp(time.Unix(1687899135, 0)),
			Joined:     chesscompubapi.UnixSecondsTimestamp(time.Unix(1389043258, 0)),
...
func TestGetPlayerStats_ShouldGetStats(t *testing.T) {
	runOutputTestWithTestServer(
		...
		func(c *chesscompubapi.Client) (chesscompubapi.PlayerStats, error) {
			return c.GetPlayerStats("erik")
		},
		chesscompubapi.PlayerStats{
...
func TestListPlayerClubs_ShouldListClubs(t *testing.T) {
	runOutputTestWithTestServer(
		...
		func(c *chesscompubapi.Client) ([]chesscompubapi.PlayerClub, error) {
			return c.ListPlayerClubs("erik")
		},
		[]chesscompubapi.PlayerClub{
			{
				ID:           "open-discussion",
				Name:         "Open Discussion",
