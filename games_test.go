...
func TestListArchives_ShouldListSingleArchive(t *testing.T) {
	runOutputTestWithTestServer(
		[]testServerRoute{
			{
				pattern:      "/pub/player/johndoe/games/archives",
				responseBody: `{"archives":["https://api.chess.com/pub/player/johndoe/games/2020/12"]}`,
				statusCode:   200,
			},
		},
		func(c *chesscompubapi.Client) ([]chesscompubapi.Archive, error) {
			return c.ListArchives("johndoe")
		},
...
func TestListArchives_ShouldListMultipleArchives(t *testing.T) {
	runOutputTestWithTestServer(
		[]testServerRoute{
			{
				pattern:      "/pub/player/janedoe/games/archives",
				responseBody: `{"archives":["https://api.chess.com/pub/player/janedoe/games/2020/09", "https://api.chess.com/pub/player/janedoe/games/2021/11"]}`,
				statusCode:   200,
			},
		},
		func(c *chesscompubapi.Client) ([]chesscompubapi.Archive, error) {
			return c.ListArchives("janedoe")
		},
		[]chesscompubapi.Archive{{
			Username: "janedoe",
			Year:     2020,
...
func TestListArchives_ShouldListNoArchives(t *testing.T) {
	runOutputTestWithTestServer(
		[]testServerRoute{
			{
				pattern:      "/pub/player/noarchives/games/archives",
				responseBody: `{"archives":[]}`,
				statusCode:   200,
			},
		},
		func(c *chesscompubapi.Client) ([]chesscompubapi.Archive, error) {
			return c.ListArchives("noarchives")
		},
		[]chesscompubapi.Archive{},
		t,
	)
...
func TestListGames_ShouldListNoGames(t *testing.T) {
	runOutputTestWithTestServer(
		[]testServerRoute{
			{
				pattern:      "/pub/player/nogames/games/2020/12",
				responseBody: `{"games":[]}`,
				statusCode:   200,
			},
		},
		func(c *chesscompubapi.Client) ([]chesscompubapi.Game, error) {
			return c.ListGames(chesscompubapi.Archive{
				Username: "nogames",
				Year:     2020,
				Month:    12,
			})
...
func TestListGames_ShouldListGames(t *testing.T) {
	runOutputTestWithTestServer(
		[]testServerRoute{
			{
				pattern: "/pub/player/erik/games/2009/10",
				responseBody: `{
					"games":[
						{
...
1. e4 d6 2. d4 Nf6 3. Nc3 g6 4. Nf3 Bg7 5. Be3 O-O 6. Bd3 c6 7. h3 b5 8. b4 a5 9. a3 Bb7 10. O-O Nbd7 11. Ne2 c5 12. dxc5 Nxe4 13. Bxe4 Bxe4 14. Rb1 dxc5 15. Ng5 Bc6 16. c3 axb4 17. cxb4 c4 18. Nd4 Qc7 19. Nxc6 Qxc6 20. Qe2 Ne5 21. Bc5 Nd3 22. h4 Nxc5 23. bxc5 Qxc5 24. Qf3 Rxa3 25. Qb7 Rb3 26. Rxb3 cxb3 27. Qe4 e6 28. Nf3 Qc4 29. Qb1 Qc2 30. Qxc2 bxc2 31. Rc1 Rc8 32. Ne1 b4 33. Rxc2 Rxc2 34. Nxc2 b3 35. Na3 Kf8 36. Nb1 Ke7 37. Kf1 Kd6 38. Nd2 b2 39. Nb1 Kc5 40. Ke2 Kc4 41. Kd2 Kb3 42. Kd3 Ka2 43. Kc2 f5 44. g3 h6 45. f3 g5 46. hxg5 hxg5 47. Nd2 e5 48. Nb1 e4 49. fxe4 fxe4 0-1`
	...
	runOutputTestWithTestServer(
		[]testServerRoute{
			{
				pattern:      "/pub/player/erik/games/2020/12/pgn",
				responseBody: pgn,
				statusCode:   200,
			},
		},
		func(c *chesscompubapi.Client) (string, error) {
			return c.GetPGN(chesscompubapi.Archive{
				Username: "erik",
				Year:     2020,
				Month:    12,
			})
